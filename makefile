run: 
	...
	time ./app.out -f ./instancias/quality/instances/berlin52FSTCII_q2_g4_p50_r10_s10_rs5.pop -MIN_PRIZE 3500 -MIN_PROB 0.7 -K 2 -T 10 -maxNotImproviment 1500 -seed 13
	rm -f *.o app.out
